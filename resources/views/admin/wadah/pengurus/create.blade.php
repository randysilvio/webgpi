...
@section('title', 'Registrasi Pengurus Kategorial')

@section('content')
    <x-admin-form 
        title="Formulir Penetapan Pengurus Wadah Kategorial" 
        action="{{ route('admin.wadah.pengurus.store') }}" 
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select id="tingkat" name="tingkat" class="w-full border border-gray-300 rounded text-sm focus:ring-blue-800 focus:border-blue-800 shadow-sm bg-white" required onchange="handleTingkatChange()">
                            ...
                            <option value="sinode" {{ old('tingkat') == 'sinode' ? 'selected' : '' }}>Tingkat Sinode</option>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input id="anggota_jemaat_id" type="number" name="anggota_jemaat_id" value="{{ old('anggota_jemaat_id') }}" 
                            ...
                            placeholder="Cth: 1024" />
                        <p class="text-[10px] text-gray-500 mt-1">Isi jika pengurus terdata di sensus anggota jemaat.</p>
