...
@section('header-title', 'Edit Data: ' . $pendeta->nama_lengkap)

@section('content')
<div class="bg-white shadow rounded-lg p-6 md:p-8">
    <h2 class="text-xl font-semibold text-gray-800 mb-6 border-b pb-3">Formulir Edit Pendeta</h2>
    ...
    <form action="{{ route('admin.pendeta.update', $pendeta->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <section class="mb-8 border rounded-lg p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-4">
                ...
                <div>
                    ...
                    <input type="text" id="nama_lengkap" name="nama_lengkap" value="{{ old('nama_lengkap', $pendeta->nama_lengkap) }}" required
                ...
                <div>
                    ...
                    <input type="text" id="nik" name="nik" value="{{ old('nik', $pendeta->nik) }}"
                ...
                <div>
                    ...
                    <input type="text" id="nipg" name="nipg" value="{{ old('nipg', $pendeta->nipg) }}" required
                ...
                <div>
                    ...
                    <input type="text" id="tempat_lahir" name="tempat_lahir" value="{{ old('tempat_lahir', $pendeta->tempat_lahir) }}" required
                ...
                <div>
                    ...
                    <input type="date" id="tanggal_lahir" name="tanggal_lahir" value="{{ old('tanggal_lahir', optional($pendeta->tanggal_lahir)->format('Y-m-d')) }}" required
                ...
                <div>
                    ...
                    <select id="jenis_kelamin" name="jenis_kelamin" required
                        ...
                        <option value="" disabled {{ !old('jenis_kelamin', $pendeta->jenis_kelamin) ? 'selected' : '' }}>-- Pilih --</option>
                ...
                <div>
                    ...
                    <select id="status_pernikahan" name="status_pernikahan"
                        ...
                        <option value="" disabled {{ !old('status_pernikahan', $pendeta->status_pernikahan) ? 'selected' : '' }}>-- Pilih --</option>
                        <option value="Belum Menikah" {{ old('status_pernikahan', $pendeta->status_pernikahan) == 'Belum Menikah' ? 'selected' : '' }}>Belum Menikah</option>
                        <option value="Menikah" {{ old('status_pernikahan', $pendeta->status_pernikahan) == 'Menikah' ? 'selected' : '' }}>Menikah</option>
                        <option value="Cerai Hidup" {{ old('status_pernikahan', $pendeta->status_pernikahan) == 'Cerai Hidup' ? 'selected' : '' }}>Cerai Hidup</option>
                        <option value="Cerai Mati" {{ old('status_pernikahan', $pendeta->status_pernikahan) == 'Cerai Mati' ? 'selected' : '' }}>Cerai Mati</option>
                    </select>
                </div>
                 {{-- Nama Pasangan --}}
                <div>
                    <label for="nama_pasangan" class="block text-sm font-medium text-gray-700 mb-1">Nama Suami/Istri</label>
                    <input type="text" id="nama_pasangan" name="nama_pasangan" value="{{ old('nama_pasangan', $pendeta->nama_pasangan) }}"
                ...
                <div>
                    ...
                    <input type="tel" id="telepon" name="telepon" value="{{ old('telepon', $pendeta->telepon) }}"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="alamat_domisili" name="alamat_domisili" rows="3"
                              class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-sm">{{ old('alamat_domisili', $pendeta->alamat_domisili) }}</textarea>
                </div>
                 {{-- Email --}}
                 <div class="md:col-span-1">
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email', $pendeta->email) }}"
        ...
        <section class="mb-8 border rounded-lg p-6">
             ...
             <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-4">
                ...
                <div>
                    ...
                    <input type="date" id="tanggal_tahbisan" name="tanggal_tahbisan" value="{{ old('tanggal_tahbisan', optional($pendeta->tanggal_tahbisan)->format('Y-m-d')) }}" required
                ...
                <div>
                    ...
                    <input type="text" id="tempat_tahbisan" name="tempat_tahbisan" value="{{ old('tempat_tahbisan', $pendeta->tempat_tahbisan) }}" required
                ...
                <div>
                    ...
                    <input type="text" id="nomor_sk_kependetaan" name="nomor_sk_kependetaan" value="{{ old('nomor_sk_kependetaan', $pendeta->nomor_sk_kependetaan) }}"
                           class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-sm">
                </div>
                 {{-- Status Kepegawaian --}}
                <div>
                    ...
                    <select id="status_kepegawaian" name="status_kepegawaian" required
                        ...
                        <option value="Aktif" {{ old('status_kepegawaian', $pendeta->status_kepegawaian) == 'Aktif' ? 'selected' : '' }}>Aktif</option>
                        <option value="Vikaris" {{ old('status_kepegawaian', $pendeta->status_kepegawaian) == 'Vikaris' ? 'selected' : '' }}>Vikaris</option>
                        <option value="Emeritus" {{ old('status_kepegawaian', $pendeta->status_kepegawaian) == 'Emeritus' ? 'selected' : '' }}>Emeritus</option>
                        <option value="Tugas Belajar" {{ old('status_kepegawaian', $pendeta->status_kepegawaian) == 'Tugas Belajar' ? 'selected' : '' }}>Tugas Belajar</option>
                        <option value="Izin Belajar" {{ old('status_kepegawaian', $pendeta->status_kepegawaian) == 'Izin Belajar' ? 'selected' : '' }}>Izin Belajar</option>
                        <option value="Dikaryakan" {{ old('status_kepegawaian', $pendeta->status_kepegawaian) == 'Dikaryakan' ? 'selected' : '' }}>Dikaryakan di Luar GPI</option>
                        <option value="Non-Aktif" {{ old('status_kepegawaian', $pendeta->status_kepegawaian) == 'Non-Aktif' ? 'selected' : '' }}>Non-Aktif</option>
                        <option value="Lainnya" {{ old('status_kepegawaian', $pendeta->status_kepegawaian) == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="text" id="pendidikan_teologi_terakhir" name="pendidikan_teologi_terakhir" value="{{ old('pendidikan_teologi_terakhir', $pendeta->pendidikan_teologi_terakhir) }}"
                ...
                <div>
                    ...
                    <input type="text" id="institusi_pendidikan_teologi" name="institusi_pendidikan_teologi" value="{{ old('institusi_pendidikan_teologi', $pendeta->institusi_pendidikan_teologi) }}"
                           class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-sm">
                </div>
                 {{-- Tanggal Masuk GPI --}}
                <div>
                    <label for="tanggal_mulai_masuk_gpi" class="block text-sm font-medium text-gray-700 mb-1">Tanggal Mulai Masuk GPI</label>
                    <input type="date" id="tanggal_mulai_masuk_gpi" name="tanggal_mulai_masuk_gpi" value="{{ old('tanggal_mulai_masuk_gpi', optional($pendeta->tanggal_mulai_masuk_gpi)->format('Y-m-d')) }}"
                           class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-sm">
                </div>
                 {{-- Golongan/Pangkat --}}
                 <div>
                    ...
                    <input type="text" id="golongan_pangkat_terakhir" name="golongan_pangkat_terakhir" value="{{ old('golongan_pangkat_terakhir', $pendeta->golongan_pangkat_terakhir) }}"
                           class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-sm">
                </div>
             </div>
         </section>
            ...
            <h3 class="text-lg font-semibold text-gray-700 mb-4">3. Penempatan & Jabatan Saat Ini</h3>
             <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-4">
                    ...
                    <select id="klasis_penempatan_id" name="klasis_penempatan_id"
                        ...
                        <option value="">-- Tidak Ada/Sinode/Lainnya --</option>
                         @foreach ($klasisOptions as $id => $nama)
                            <option value="{{ $id }}" {{ old('klasis_penempatan_id', $pendeta->klasis_penempatan_id) == $id ? 'selected' : '' }}>{{ $nama }}</option>
                        @endforeach
                    </select>
                    ...
                    <select id="jemaat_penempatan_id" name="jemaat_penempatan_id"
                        ...
                        <option value="">-- Tidak Ada/Bukan Jemaat --</option>
                         ...
                         @foreach ($jemaatOptions as $id => $nama)
                            <option value="{{ $id }}" {{ old('jemaat_penempatan_id', $pendeta->jemaat_penempatan_id) == $id ? 'selected' : '' }}>{{ $nama }}</option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <input type="text" id="jabatan_saat_ini" name="jabatan_saat_ini" value="{{ old('jabatan_saat_ini', $pendeta->jabatan_saat_ini) }}"
                ...
                <div>
                    ...
                    <input type="date" id="tanggal_mulai_jabatan_saat_ini" name="tanggal_mulai_jabatan_saat_ini" value="{{ old('tanggal_mulai_jabatan_saat_ini', optional($pendeta->tanggal_mulai_jabatan_saat_ini)->format('Y-m-d')) }}"
                           class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-sm">
                </div>
             </div>
        </section>
        ...
        <section class="mb-8 border rounded-lg p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                 {{-- Foto Pendeta --}}
                <div>
                    <label for="foto_path" class="block text-sm font-medium text-gray-700 mb-1">Ganti Foto Diri <span class="italic text-gray-500">(Opsional)</span></label>
                    ...
                    <p class="mt-1 text-xs text-gray-500">Format: JPG, PNG. Maks: 2MB. Biarkan kosong jika tidak ingin mengubah.</p>
                     @if ($pendeta->foto_path && Storage::disk('public')->exists($pendeta->foto_path))
                        <img src="{{ Storage::url($pendeta->foto_path) }}" alt="Foto Saat Ini" class="image-preview mt-2 block">
                    @else
                         <span class="text-xs text-gray-500 italic mt-2 block">Belum ada foto.</span>
                    @endif
                    <img id="foto-preview" src="#" alt="Preview Foto Baru" class="image-preview mt-2 hidden">
                ...
                <div>
                    ...
                    <textarea id="catatan" name="catatan" rows="4"
                              class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-sm">{{ old('catatan', $pendeta->catatan) }}</textarea>
                </div>
            </div>
        </section>
