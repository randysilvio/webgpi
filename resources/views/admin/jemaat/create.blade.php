...
<div class="bg-white shadow rounded-lg p-6 md:p-8">
    <div class="flex justify-between items-center mb-6 border-b pb-3">
        <h2 class="text-xl font-semibold text-gray-800">Formulir Jemaat Baru</h2>
        <div class="text-xs bg-blue-50 text-blue-700 px-3 py-1 rounded-full font-medium">
            <i class="fas fa-info-circle mr-1"></i> Statistik KK & Jiwa akan dihitung otomatis dari data Anggota
        </div>
    </div>
    ...
    <form action="{{ route('admin.jemaat.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea id="alamat_gereja" name="alamat_gereja" rows="3"
                              class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-sm" placeholder="Jl. Contoh No. 1, Kampung ABC...">{{ old('alamat_gereja') }}</textarea>
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                {{-- Foto Gereja --}}
                <div class="pt-2">
                    <label for="foto_gereja_path" class="block text-sm font-medium text-gray-700 mb-1">Foto Gedung Gereja</label>
                    ...
                    <img id="foto-preview" src="#" alt="Preview Foto Gereja" class="image-preview mt-2 hidden max-h-48 rounded shadow-sm border">
