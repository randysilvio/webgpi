    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div class="bg-white p-5 rounded border border-gray-300 shadow-sm flex items-center justify-between border-l-4 border-green-600">
            <div>
                ...
                <p class="text-lg font-mono font-black text-gray-900 mt-1">Rp {{ number_format($totalPendapatan, 0, ',', '.') }}</p>
            </div>
        ...
        <div class="bg-white p-5 rounded border border-gray-300 shadow-sm flex items-center justify-between border-l-4 border-red-600">
            <div>
                ...
                <p class="text-lg font-mono font-black text-gray-900 mt-1">Rp {{ number_format($totalBelanja, 0, ',', '.') }}</p>
            </div>
        ...
        <div class="bg-gray-800 p-5 rounded border border-gray-900 shadow-sm flex items-center justify-between text-white relative overflow-hidden">
            <div class="relative z-10">
                ...
                <p class="text-lg font-mono font-black text-white mt-1">Rp {{ number_format($totalPendapatan - $totalBelanja, 0, ',', '.') }}</p>
            </div>
                ...
                <tbody class="text-sm divide-y divide-gray-200">
                    @forelse($anggarans as $ang)
                        <tr class="hover:bg-gray-50 transition">
                            <td class="px-6 py-4">
                                <div class="font-bold text-gray-900 uppercase text-xs">{{ $ang->mataAnggaran->nama_mata_anggaran }}</div>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center text-gray-500 text-sm">
                                ...
                                Belum ada penyusunan anggaran untuk Tahun Buku {{ $tahun }}.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
